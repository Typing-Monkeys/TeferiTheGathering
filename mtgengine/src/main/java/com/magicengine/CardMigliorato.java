...
public class CardMigliorato extends MagicObject{
	...
	public CardMigliorato(CardMigliorato card, int idObject)
	{
		super(card, idObject);
	...
	public CardMigliorato(int id, int idObject)
	{
		super(idObject);
		this.faceDown = true;
		this.castable = false;
 ...
 */
			...
			System.out.println(super.getCardType().toString());
	...
	public CardMigliorato(String jsonCard, int idObject,int id)
	{
		super(idObject);
		this.faceDown = true;
		this.castable = false;
 ...
 */
	...
	public CardMigliorato(CardMigliorato card, boolean faceDown)
	{
		super(card, faceDown);
		this.faceDown = card.isFaceDown();
		if(faceDown) 
